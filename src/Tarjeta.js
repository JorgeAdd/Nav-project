...
export default class Tarjeta extends Component {
  ...
  constructor(props) {
    ...
    setInterval(this.onPostNotification.bind(this), 10000);
  }
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Button onPress={() => this.onPostNotification()}>
          <Text style={styles.mainButtonText}>Try Me!</Text>
        </Button>
        <Button onPress={() => this.onCancelNotification()}>
          <Text style={styles.plainButtonText}>Undo last</Text>
        </Button>
        <Button onPress={() => this.onCheckPermissions()}>
